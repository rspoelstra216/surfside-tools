...
define('SURFSIDE_TOOLS_VERSION', '3.3.0');
...
require_once SURFSIDE_TOOLS_PATH . 'includes/mobile-admin-access.php';
...
require_once SURFSIDE_TOOLS_PATH . 'includes/calendar-suggestion-support.php';
