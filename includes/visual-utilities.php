...
function surfside_tools_visual_utilities_styles() {
    ...
    wp_add_inline_style('surfside-tools-visual-utilities', '
        body:not(.wp-admin) :is(.surfside-reveal, .surfside-section-white, .surfside-section-sand, .surfside-section-soft, .surfside-staggered-cards > *){opacity:0;transform:translateY(16px);transition:opacity 700ms ease,transform 700ms ease}
        body:not(.wp-admin) :is(.surfside-reveal, .surfside-section-white, .surfside-section-sand, .surfside-section-soft, .surfside-staggered-cards > *).is-visible{opacity:1;transform:translateY(0)}
        ...
        body:not(.wp-admin) .surfside-staggered-cards > :nth-child(2){transition-delay:.5s}
        body:not(.wp-admin) .surfside-staggered-cards > :nth-child(3){transition-delay:.75s}
        ...
        .wp-admin :is(.surfside-reveal, .surfside-section-white, .surfside-section-sand, .surfside-section-soft, .surfside-staggered-cards > *),.editor-styles-wrapper :is(.surfside-reveal, .surfside-section-white, .surfside-section-sand, .surfside-section-soft, .surfside-staggered-cards > *),.block-editor-page :is(.surfside-reveal, .surfside-section-white, .surfside-section-sand, .surfside-section-soft, .surfside-staggered-cards > *),.interface-interface-skeleton :is(.surfside-reveal, .surfside-section-white, .surfside-section-sand, .surfside-section-soft, .surfside-staggered-cards > *){opacity:1!important;transform:none!important;transition:none!important}
        ...
        @media(prefers-reduced-motion:reduce){body:not(.wp-admin) :is(.surfside-reveal, .surfside-section-white, .surfside-section-sand, .surfside-section-soft, .surfside-staggered-cards > *){opacity:1;transform:none;transition:none}}
    ');
}
...
function surfside_tools_visual_utilities_scripts() {
    ...
    (function(){
        function initReveal(){
            var items=document.querySelectorAll('.surfside-reveal, .surfside-section-white, .surfside-section-sand, .surfside-section-soft, .surfside-staggered-cards > *, .surfside-staggered-cards > *');
