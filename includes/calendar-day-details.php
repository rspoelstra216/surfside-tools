...
function surfside_tools_calendar_day_details_assets() {
    ...
    wp_add_inline_style('surfside-tools-calendar-manager', '
        .surfside-month-calendar-more{display:inline-flex;align-items:center;justify-content:center;width:100%;min-height:34px;border:1px solid rgba(11,79,156,.25);border-radius:9px;padding:7px 9px;background:#fff;color:#0b4f9c;font:inherit;font-size:12px;font-weight:900;line-height:1.2;cursor:pointer}
        ...
        <div class="surfside-month-calendar-grid" role="table" aria-label="<?php echo esc_attr($month_label); ?> calendar">
            ...
            <div class="surfside-month-calendar-days">
                <?php for ($day_ts = strtotime($grid_start . ' 12:00:00'); $day_ts <= strtotime($grid_end . ' 12:00:00'); $day_ts = strtotime('+1 day', $day_ts)) :
                    ...
                    ?>
                    <div class="surfside-month-calendar-day<?php echo $is_current_month ? '' : ' surfside-month-calendar-muted'; ?><?php echo $day_events ? ' surfside-month-calendar-has-events' : ''; ?>" role="cell">
