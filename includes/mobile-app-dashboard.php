...
function surfside_tools_staff_mobile_app_shortcode() {
    ...
    $logo_url = function_exists('surfside_tools_site_information_logo_url') ? surfside_tools_site_information_logo_url($information) : '';
        ...
        <section class="surfside-staff-panel">
          ...
          <div class="surfside-mobile-template-wrap">
            ...
            <div id="surfside-mobile-hero-stage" class="surfside-mobile-hero-stage<?php echo $image_url ? ' has-image' : ''; ?>" style="<?php echo $image_url ? 'background-image:url(' . esc_url($image_url) . ');' : ''; ?>background-position:<?php echo esc_attr($focal_x); ?>% <?php echo esc_attr($focal_y); ?>%;">
              ...
              <div class="surfside-mobile-preview-brand">
                <div class="surfside-mobile-preview-logo-box"><?php if ($logo_url) : ?><img src="<?php echo esc_url($logo_url); ?>" alt="Surfside Community Fellowship"><?php else : ?><strong>SURFSIDE</strong><?php endif; ?></div>
                <div class="surfside-mobile-preview-welcome">Welcome home.</div>
                <div class="surfside-mobile-preview-tagline"><?php echo esc_html($tagline); ?></div>
              </div>
              <div class="surfside-mobile-preview-card"><span>COMING UP</span><strong>Upcoming Event</strong><small>Event date · time</small><small>Event location</small><b>View Events</b></div>
            </div>
