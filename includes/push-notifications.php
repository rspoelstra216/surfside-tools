...
function surfside_tools_push_default_preferences(){
    return array('church_updates'=>true,'events_ministries'=>true,'kids_ministry'=>false,'livestream'=>false,'prayer_requests'=>false);
}
...
function surfside_tools_staff_push_notifications_shortcode(){
    ...
    $labels=array('church_updates'=>'Church Updates','events_ministries'=>'Events & Ministries','kids_ministry'=>'Kids Ministry','livestream'=>'Livestream Reminders','prayer_requests'=>'Prayer Requests');$notice='';$notice_type='success';
